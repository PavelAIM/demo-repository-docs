...
2. **Ввжно:** настройте безопасность:
...
<figure>
  ...
  <figcaption><strong>Рисунок 3: </strong>Управление пользователями</figcaption>
</figure>

<figure>
  <img src="img/di-admin-settings-users-groups.png" alt="Управление группами пользователей">
  <figcaption><strong>Рисунок 3: </strong>Управление группами пользователей</figcaption>
</figure>
...
1. Войдите **как администратор** в OpenWebUI → Иконка профиля: 🟠 → Admin Panel
3. **Добавьте подключение к ai-mediator.ru:**
- В разделе Settings → Connections: 
...
<figure>
  ...
  <figcaption><strong>Рисунок 4: </strong>Подключение к ai-mediator.ru...</figcaption>
</figure>

5. Управление доступными моделями:
- В разделе Settings → Models: 
...
- При необходимости оставьте для использования только часть моделей:
   ...
   > В примере набо моделей ограничен таким списком:
`chatgpt-4o-latest`, 
`gemini-2.5-pro`,
`gpt-4.1-mini`,
`o3`,
...
<figure>
  ...
  <figcaption><strong>Рисунок 4: </strong>Список всех доступных моделей</figcaption>
</figure>
...
<figure>
  ...
  <figcaption><strong>Рисунок 5: </strong> Настройка моделей для пользователей</figcaption>
</figure>



7. **Задайте первый вопрос:**
